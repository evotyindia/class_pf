...
def insert_pdfs_with_backup(main_pdf_path, output_pdf_path, inserts, backup_pdf_path):
...
main_pdf_path = "shivam_lm_evotyindia.pdf"
backup_pdf_path = "shivam_lm_evotyindia_backup.pdf"
output_pdf_path = "shivam_lm_evotyindia_modified.pdf"
...
inserts = [
    ...
    (19, "5.pdf")  # Insert `5.pdf` after page 19
]

# Run the function
insert_pdfs_with_backup(main_pdf_path, output_pdf_path, inserts, backup_pdf_path)
